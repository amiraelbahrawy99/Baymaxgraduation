      ...
      <form id="login_form" class="dialog-form" action="" method="POST">
        <fieldset>
          ...
          <div class="text-center pad-top-20">
            <p>Have you forgotten your<br><a href="#" class="link"><strong style="color:#861313">username</strong></a> or <a href="#" class="link"><strong style="color:#861313">password</strong></a>?</p>
          </div>
          <div class="pad-top-20 pad-btm-20">
            <input type="submit" class="btn btn-default btn-block btn-lg" value="Continue">
          </div>
          <div class="text-center">
            <p>Do you wish to register<br> for <a href="#" class="link user-actions"><strong style="color:#861313">a new account</strong></a>?</p>
          </div>
        </fieldset>
      </form>
    </div>
    ...
    <div class="dialog-content">
      <form id="register_form" class="dialog-form" action="" method="POST">
        <fieldset>
          ...
          <div class="text-center">
            <p>Return to <a href="#" class="link user-actions"><strong style="color:#861313">log in page</strong></a>?</p>
          </div>
        </fieldset>
      </form>
    </div>
